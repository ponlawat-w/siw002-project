...
--- 6. How many disaster by type occured in Phuket in last three months (90 days)? Order the result by occurrance descending.
SELECT d.type "Disaster Type", COUNT(*) "Occurance"
  FROM disasters d,
    (SELECT ST_GeomFromText('POLYGON((98.19970916174111 8.002429215766703,98.26013396642861 8.279757032963346,98.44140838049111 8.203646997340972,98.48535369299111 8.029626669965772,98.55676482580361 7.626921611182967,98.49634002111611 7.229286713053067,98.25464080236611 7.229286713053067,98.18322966955361 7.6160323374499255,98.19970916174111 8.002429215766703))', 4326) geo) phuket
