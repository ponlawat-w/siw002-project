...
INSERT INTO social_media_messages (id, message, published_by, published_datetime, social_media, geo) VALUES
  (1, 'The wall of my house is cracked!!', 'somchai123', TIMESTAMP '2019-12-12 18:23:15', 1, ST_GeomFromText('POINT(99.35334664941854 20.00599665692158)', 4326)),
  (2, 'Roof is collapsed!!! My dog is in the house! HELP!!!', 'tawatchai', TIMESTAMP '2019-12-12 18:33:21', 2, ST_GeomFromText('POINT(99.34756749424889 20.004682759949375)', 4326)),
  (3, 'Black out!!! No electric!!!!!', 'ghargsd', TIMESTAMP '2019-12-12 17:30:00', 2, ST_GeomFromText('POINT(99.3321650449825 20.02690601936971)', 4326)),
  (4, 'Please fix the electricity before it gets dark', 'pleaseplease', TIMESTAMP '2019-12-12 17:32:23', 2, ST_GeomFromText('POINT(99.35207776470907 20.021744931753915)', 4326));
INSERT INTO social_media_messages (id, message, published_by, published_datetime, social_media, geo) VALUES
  (101, 'Earthquake !! I see people trapped in the house!!', '@cnnJournalist', TIMESTAMP '2019-10-05 12:20:05', 2, ST_GeomFromText('POINT(102.4263821 17.2144061)', 4326)),
  (102, 'Earthquake !! We are many people taking shelter in school here we need drinking water!!', 'Apinya WeeraanduBisista', TIMESTAMP '2019-10-05 12:22:05', 1, ST_GeomFromText('POINT(99.8585839 19.9511766)', 4326)),
  (103, 'This bridge is collapsed by the flood, vehicles cannot pass it', 'Paithoon', TIMESTAMP '2019-11-10 16:35:05', 1, ST_GeomFromText('POINT(102.543 13.543)', 4326)),
  (104, 'Tsunami just took away this house', 'John', TIMESTAMP '2019-09-02 12:20:05', 3, ST_GeomFromText('POINT(100 8)', 4326));
INSERT INTO social_media_messages (id, message, published_by, published_datetime, social_media, geo) VALUES
  (201, 'Flood !! The village is inundated!!', 'sagar111', TIMESTAMP '2019-11-15 13:20:05', 2, ST_GeomFromText('POINT(102.4386558884521 17.208728495144474)', 4326)),
  (202, 'The earth is crumbling !! crisis situation here!!', 'Deepak Sahil', TIMESTAMP '2012-12-15 07:22:05', 4, ST_GeomFromText('POINT(99.8585739 19.9611766)', 4326)),
  (203, 'I am trapped in my house. The earth is crumbling', 'Samurai', TIMESTAMP '2019-11-10 16:35:05', 1, ST_GeomFromText('POINT(102.643 13.773)', 4326)),
  (204, 'Earthquake is killing me', 'Ponpisit', TIMESTAMP '2019-10-12 12:30:15', 2, ST_GeomFromText('POINT(100.212 9.217)', 4326)),
